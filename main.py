...
crypto = pyCryptoPayAPI(api_token="токен криптобот прилодения")

bot_token = '8318187834:AAGW5LKI5KtRBuxdmoo4_Mliy-KkNQVW6-E'
owner_id = 7504103313
channel_id = '-1003534275338'  # ID вашего канала
channel_username = 'punshersnos'  # Имя вашего канала без "@"
name_bot = 'punisher' #имя бота
...
def info(call):
    ...
    def channel(call):
        ...
        btn_subscribe = telebot.types.InlineKeyboardButton(text='🌐 Канал с Новостями', url='https://t.me/PickImail')
    ...
    def support(call):
        markup = telebot.types.InlineKeyboardMarkup()
        btn_subscribe = telebot.types.InlineKeyboardButton(text='🌐Тех. Поддержка', url='https://t.me/HickariTag')
        markup.add(btn_subscribe)
